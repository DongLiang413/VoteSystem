...
public class Candidate implements Comparable<Candidate> {
     ...
     * @return Confirmation it was reset.
     */
    ...
    /**
     * Special method for the IR where votes get transfered from Candidate to Candidate.
     * @param another The Candidate to add this Candidate's votes to.
     */

    // IR special case
    public void transferTo(Candidate another) {
        another.addVotes(this.votes);
        this.reset();
    }
